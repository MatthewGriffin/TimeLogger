...
import { normalizeNotes, type Note, type NoteTopic } from '../utils/state-adapters'
import { localDate } from '../utils/dates'
import type { TopicSuggestion } from '../models/notes'

export type { Note, NoteTopic }
export type { BackendNote, TopicSuggestion } from '../models/notes'
