...
pub fn run() {
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![start_backend, stop_backend, api_request, backend_health, enable_autostart, disable_autostart, open_external_url, open_logs_folder, write_backup_file, read_backup_file, test_jira_connection, test_graph_connection, test_tempo_connection, test_ollama_connection, complete_setup, get_setup_status, get_oauth_status, get_oauth_authorize_url, get_app_data_dir, write_microsoft_oauth_signal, read_microsoft_oauth_signal, start_microsoft_oauth, show_notification, show_submission_success_notification, show_submission_error_notification, show_daily_reminder_notification, show_tempo_reminder_notification])
